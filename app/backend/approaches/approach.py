...
class Approach(ABC):
    def __init__(
        ...
        """
        Initializes the Approach object with the necessary parameters.
        """
    ...
    async def search(
        ...
        """
        Performs a search based on the provided parameters and returns a list of Document objects.
        """
    ...
    async def run(
        ...
        """
        Runs the approach based on the provided messages and returns the results.
        """
